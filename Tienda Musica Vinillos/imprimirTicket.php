...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.codigo, p.descripcion, p.categoria, p.precio, pv.cantidad
FROM productos p
INNER JOIN 
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="nom" style="text-align:center;"><?php echo $producto->categoria;  ?></td>
                        <td class="producto" style="text-align:center;"><?php echo $producto->descripcion;  ?></td>
                        <td class="precio" style="text-align:center;"><strong>$<?php echo number_format($producto->precio, 2) ?></strong></td>
